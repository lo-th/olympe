...
function speak(text, args) {
  ...
  function parseWav(wav) {
    // document.getElementById("timeComplete").innerHTML = 0;
  ...
  function playHTMLAudioElement(wav) {
    ...
    document.getElementById("timeComplete").innerHTML = 1;
  }
  ...
  function handleWav(wav) {
    ...
    if (PROFILE) {
      ...
      document.getElementById("timeWav").innerHTML = (Date.now()-startTime).toFixed(2) ;
    }
  }
  ...
  if (args && args.noWorker) {
    ...
    speakWorker.onmessage = function(event) {
      if (PROFILE) {
        ...
        document.getElementById("timeProcess").innerHTML = (Date.now()-startTime).toFixed(2) ;
      }
