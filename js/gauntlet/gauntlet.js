Gauntlet = function() {
  ...
  var cfg = {
    ...
    images: [
      { id: 'backgrounds', url: "res/images/backgrounds.png" }, // http://opengameart.org/content/gauntlet-like-tiles
      { id: 'entities',    url: "res/images/entities.png"    }  // http://opengameart.org/forumtopic/request-for-tileset-spritesheet-similar-to-gauntlet-ii 
    ],

    sounds: [
      { id: 'lostcorridors',   name: 'res/sounds/music.lostcorridors',   formats: ['mp3', 'ogg'], volume: 1.0, loop: true             }, // http://luckylionstudios.com/
      { id: 'bloodyhalo',      name: 'res/sounds/music.bloodyhalo',      formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, // (ditto)
      { id: 'citrinitas',      name: 'res/sounds/music.citrinitas',      formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, //
      { id: 'fleshandsteel',   name: 'res/sounds/music.fleshandsteel',   formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, //
      { id: 'mountingassault', name: 'res/sounds/music.mountingassault', formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, //
      { id: 'phantomdrone',    name: 'res/sounds/music.phantomdrone',    formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, //
      { id: 'thebeginning',    name: 'res/sounds/music.thebeginning',    formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, //
      { id: 'warbringer',      name: 'res/sounds/music.warbringer',      formats: ['mp3', 'ogg'], volume: 0.5, loop: true             }, //
      { id: 'gameover',        name: 'res/sounds/gameover',              formats: ['mp3', 'ogg'], volume: 0.5                         }, //
      { id: 'victory',         name: 'res/sounds/victory',               formats: ['mp3', 'ogg'], volume: 1.0                         }, //
      { id: 'femalepain1',     name: 'res/sounds/femalepain1',           formats: ['mp3', 'ogg'], volume: 0.3                         }, // http://www.premiumbeat.com/sfx/
      { id: 'femalepain2',     name: 'res/sounds/femalepain2',           formats: ['mp3', 'ogg'], volume: 0.3                         }, // (ditto)
      { id: 'malepain1',       name: 'res/sounds/malepain1',             formats: ['mp3', 'ogg'], volume: 0.3                         }, //
      { id: 'malepain2',       name: 'res/sounds/malepain2',             formats: ['mp3', 'ogg'], volume: 0.3                         }, //
      { id: 'exitlevel',       name: 'res/sounds/exitlevel',             formats: ['mp3', 'ogg'], volume: 1.0,                        }, //
      { id: 'highscore',       name: 'res/sounds/highscore',             formats: ['mp3', 'ogg'], volume: 1.0,                        }, //
      { id: 'firewarrior',     name: 'res/sounds/firewarrior',           formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //   NOTE: ie has limit of 40 <audio> so be careful with pool amounts
      { id: 'firevalkyrie',    name: 'res/sounds/firevalkyrie',          formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'firewizard',      name: 'res/sounds/firewizard',            formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'fireelf',         name: 'res/sounds/fireelf',               formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'collectgold',     name: 'res/sounds/collectgold',           formats: ['mp3', 'ogg'], volume: 0.5, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'collectpotion',   name: 'res/sounds/collectpotion',         formats: ['mp3', 'ogg'], volume: 0.5, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'collectkey',      name: 'res/sounds/collectkey',            formats: ['mp3', 'ogg'], volume: 0.5, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'collectfood',     name: 'res/sounds/collectfood',           formats: ['mp3', 'ogg'], volume: 0.5, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'generatordeath',  name: 'res/sounds/generatordeath',        formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'monsterdeath1',   name: 'res/sounds/monsterdeath1',         formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'monsterdeath2',   name: 'res/sounds/monsterdeath2',         formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'monsterdeath3',   name: 'res/sounds/monsterdeath3',         formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 }, //
      { id: 'opendoor',        name: 'res/sounds/opendoor',              formats: ['mp3', 'ogg'], volume: 0.3, pool: ua.is.ie ? 2 : 4 } //
    ],

    levels: [
      { name: 'Test Level',     url: "res/levels/testlevel.png", floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: null }, 
      { name: 'Training',       url: "res/levels/trainer1.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Shoot ghosts and find the exit" },
      { name: 'Training Two',   url: "res/levels/trainer2.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Watch out for demon fire" },
      { name: 'Training Three', url: "res/levels/trainer3.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Find keys to open doors" },
      { name: 'Training Four',  url: "res/levels/trainer4.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Eat and drink to restore health" },
      { name: 'Training Five',  url: "res/levels/trainer5.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Collect treasure for high score" },
      { name: 'Training Six',   url: "res/levels/trainer6.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Destroy monster generators" },
      { name: 'Training Seven', url: "res/levels/trainer7.png",  floor: FLOOR.LIGHT_STONE,      wall: WALL.BLUE_COBBLE,      music: 'bloodyhalo',      score:  1000, help: "Use potions to destroy all monsters" },
      { name: 'Dungeon One',    url: "res/levels/level1.png",    floor: FLOOR.WOOD,             wall: WALL.CONCRETE,         music: 'citrinitas',      score:  1000, help: "Training is over!<br><br> Welcome to the Dungeon!" },
      { name: 'Dungeon Two',    url: "res/levels/level2.png",    floor: FLOOR.WOOD,             wall: WALL.CONCRETE,         music: 'citrinitas',      score:  2000, help: null },
      { name: 'Dungeon Three',  url: "res/levels/level3.png",    floor: FLOOR.DARK_STONE,       wall: WALL.BLUE,             music: 'fleshandsteel',   score:  3000, help: null },
      { name: 'Dungeon Four',   url: "res/levels/level4.png",    floor: FLOOR.DARK_STONE,       wall: WALL.BLUE,             music: 'fleshandsteel',   score:  4000, help: null },
      { name: 'Dungeon Five',   url: "res/levels/level5.png",    floor: FLOOR.BROWN_LAMINATE,   wall: WALL.CONCRETE,         music: 'phantomdrone',    score:  5000, help: null },
      { name: 'Dungeon Six',    url: "res/levels/level6.png",    floor: FLOOR.BROWN_LAMINATE,   wall: WALL.CONCRETE,         music: 'phantomdrone',    score:  6000, help: null },
      { name: 'Dungeon Seven',  url: "res/levels/level7.png",    floor: FLOOR.PURPLE_LAMINATE,  wall: WALL.PURPLE_COBBLE,    music: 'thebeginning',    score:  7000, help: null },
      { name: 'Dungeon Eight',  url: "res/levels/level8.png",    floor: FLOOR.WOOD,             wall: WALL.BLUE_BRICK,       music: 'mountingassault', score:  8000, help: null },
      { name: 'Dungeon Nine',   url: "res/levels/level9.png",    floor: FLOOR.PURPLE_LAMINATE,  wall: WALL.CONCRETE,         music: 'fleshandsteel',   score:  9000, help: null },
      { name: 'Dungeon Ten',    url: "res/levels/level10.png",   floor: FLOOR.WOOD,             wall: WALL.BLUE_BRICK,       music: 'warbringer',      score: 10000, help: "Final Level<br><br>Good Luck!" }
    ],
    ...
    setupLevel: function(nlevel) {
      ...
      Game.parseImage(source, function(tx, ty, pixel, map) {
        ...
        if (iswall(pixel)){
          ...
          //////////////////////////////////////
          add3DFloor(tx, ty, DEBUG.FLOOR || level.floor, cell.shadow);
          //////////////////////////////////////
          }
        if (isexit(pixel))
